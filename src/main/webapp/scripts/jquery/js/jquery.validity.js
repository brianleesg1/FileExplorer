...
(function($) {
    ...
    $.fn.extend({
            ...
            return validate(
                ...
                min.getTime && max.getTime ?
                    ...
                    function(obj) {
                        ...
                        var d = baseCommons.toDate(obj.value);
        ...
        greaterThanOrEqualTo:function(min, msg) {
            return validate(
                ...
                min.getTime ?
                    function(obj) {
                		var d = baseCommons.toDateHHMMSS(obj.value + "235959");
                		//console.log(d);
                		//console.log(min);
                        return d >= min;
                    } :
            ...
            return validate(
                ...
                max.getTime ?
                    function(obj) {
                		...
                		//console.log("1 max.getTime : " + max.getTime());
                		
                		var dd = baseCommons.toDate(obj.value);
                		//console.log(dd);
                		//console.log(max);
                        return dd <= max;
                    } :
                    ...
                    max.substring && Big ?
                        ...
                        function(obj) {
                    		//console.log("2 Big(obj.value) : " + new Big(obj.value));
                    		//console.log("2 Big(max) : " + new Big(max));
    ...
    function validate($obj, regimen, message) {
        ...
        $reduction.each(
            function() {
                ...
                //console.log("regimen(this) : " + regimen(this));
            	if (regimen(this)) {
                    elements.push(this);
                }
    ...
    function infer(field) {
        ...
        // Check for title.
        if ($f != null && $f.attr("title") != null && $f.attr("title").length) {
            ret = $f.attr("title");
        }
...
(function($) {
    ...
    $.validity.settings.cssClass = errorClass;
